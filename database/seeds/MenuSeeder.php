...
class MenuSeeder extends Seeder
{
    ...
    protected function getDisplayName($class){
        ...
        $instance = new $class;
        $name =  $reflectionClass->getProperty('display_name')->getValue($instance);
        return ucwords($name);
    }
    ...
    protected function getPermissionId($class){
       ...
       $permissionName = $name.'-'.'list';
        return optional($this->permissions->firstWhere('name',$permissionName))->id;
    }
}
