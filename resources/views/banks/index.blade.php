        ...
        <div class='kt-portlet'>
            <div class='kt-portlet__head'>
                ...
                <div class='kt-portlet__head-toolbar'>
                    <a href='{{ route('banks.create') }}' class='btn btn-primary kt-margin-r-10'>
                        <i class='la la-plus'></i>
                            <span class='kt-hidden-mobile'>Create Bank</span>
                    </a>
                </div>
                @endpermission
            </div>
                                ...
                                <tbody>
                                    <tr class="table-primary">
                                        ...
                                        <td class="text-center" style="width:120px;">
                                            ...
                                            <a href="{{ route('banks.index') }}" class="btn btn-danger btn-icon"><i class="fa fa-ban"></i></a>
                                        </td>
                                    </tr>
                                    @foreach ($items as $item)
                                        <tr>
                                            ...
                                            <td class='text-center'>
                                                ...
                                                <a href='{{ route('banks.edit',['bank'=>$item->id]) }}' class='btn btn-secondary'>Edit</a>
                                                @endpermission
                                            </td>
                                        </tr>
                                    @endforeach
