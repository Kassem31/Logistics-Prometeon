     ...
     <div class='kt-portlet'>
         <div class='kt-portlet__head'>
             ...
             <div class="kt-portlet__head-toolbar">
                <a href="{{ route('roles.create') }}" class="btn btn-primary kt-margin-r-10">
                    <i class="la la-plus"></i>
                    <span class="kt-hidden-mobile">Create Role</span>
                </a>
            </div>
            @endpermission
         </div>
                                ...
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td class='text-center'>
                                            ...
                                            <a href='{{ route('roles.edit',['role'=>$item->id]) }}' class='btn btn-secondary'>Edit</a>
                                            @endpermission
                                        </td>
                                    </tr>
                                @endforeach
