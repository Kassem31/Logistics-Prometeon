            ...
            <div class='kt-portlet__head'>
                <div class='kt-portlet__head-label'>
                    <h3 class='kt-portlet__head-title'>
                        Edit Inco Term : {{ $model->name }}
                    </h3>
                </div>
            </div>
            <form action='{{ route('inco-terms.update',['inco_term'=>$model]) }}' class='kt-form kt-form--label-right' method='POST' >
                @csrf
                @method('put')
                    ...
                    <div class='kt-form__actions'>
                        <div class='row'>
                            ...
                            <div class='col-lg-6'>
                                ...
                                <a href='{{ route('inco-terms.index') }}' class='btn btn-secondary'>Cancel</a>
                            </div>
                        <div>
                    </div>
                </div>
