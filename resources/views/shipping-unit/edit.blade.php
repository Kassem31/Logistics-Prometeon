            ...
            <div class='kt-portlet__head'>
                <div class='kt-portlet__head-label'>
                    <h3 class='kt-portlet__head-title'>
                        Edit Shipping Unit : {{ $model->name }}
                    </h3>
                </div>
            </div>
            <form action='{{ route('shipping-unit.update',['shipping_unit'=>$model]) }}' class='kt-form kt-form--label-right' method='POST' >
                @csrf
                @method('put')
                    ...
                    <div class='kt-form__actions'>
                        <div class='row'>
                            ...
                            <div class='col-lg-6'>
                                ...
                                <a href='{{ route('shipping-unit.index') }}' class='btn btn-secondary'>Cancel</a>
                            </div>
                        <div>
                    </div>
                </div>
