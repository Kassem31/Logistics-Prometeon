...
@section('container')
    <div class='row'>
        <div class='kt-portlet'>
            ...
            <form action='{{ route('countries.store') }}' class='kt-form kt-form--label-right' method='POST' enctype="multipart/form-data" >
                @csrf
                    ...
                    <div class='kt-section kt-section--first'>
                        <div class='kt-section__body'>
                            ...
                            <div class='form-group row'>
                                ...
                                <div class='col-lg-6'>
                                    <input type='text' class='form-control @error('currency') is-invalid @enderror' placeholder='Currency' name='currency'  value='{{ old('currency') }}'>
                                    @error('currency')
                                        <span class='form-text text-danger'>{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-3">
                                    <span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--success">
                                        <label>
                                            <input type="checkbox" name="currency_is_active" {{ old('currency_is_active') ? 'checked' : '' }}>
                                            <span></span>
                                        </label>
                                    </span>
                                </div>
