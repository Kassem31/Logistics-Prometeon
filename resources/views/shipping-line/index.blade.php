    ...
    <div class='row'>
        <div class='kt-portlet'>
            <div class='kt-portlet__head'>
                ...
                @permission('ShippingLine-create')
                <div class='kt-portlet__head-toolbar'>
                    <a href='{{ route('shipping-line.create') }}' class='btn btn-primary kt-margin-r-10'>
                        <i class='la la-plus'></i>
                        <span class='kt-hidden-mobile'>Create Shipping Line</span>
                    </a>
                </div>
                @endpermission
            </div>
                                ...
                                <tbody>
                                    @foreach ($items as $item)
                                        <tr>
                                            ...
                                            <td class='text-center'>
                                                @permission('ShippingLine-edit')
                                                <a href='{{ route('shipping-line.edit',['shipping_line'=>$item->id]) }}' class='btn btn-secondary'>Edit</a>
                                                @endpermission
                                            </td>
                                        </tr>
                                    @endforeach
